...
123
4294967329,4294967329,0
Received watched event WatchedEvent state:SyncConnected type:NodeDataChanged path:/zk-bookAsy
123
4294967329,4294967330,1

 */
public class GetData_API_Asy_Usage implements Watcher{
    private static CountDownLatch connectedSemaphore=new CountDownLatch(1);
    private static ZooKeeper zookeeper= null;
    private static Stat stat=new Stat();

    public static void main(String[] args) throws  Exception{
        String path="/zk-bookAsy";
        zookeeper=new ZooKeeper("10.155.20.155:2181",5000,new GetData_API_Asy_Usage());
    ...
    class IData2Callback implements AsyncCallback.DataCallback{
